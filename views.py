...
def send_email(request):
    if request.method == 'POST':
        ...
        recipients = ['ajay.sai0808@gmail.com','saiayyagari13@gmail.com','baljotsinghrait607@gmail.com']
        
        sender_email = formataddr(('Vehicle Social Network', 'hello@gmail.com'))
        
        send_mail(
            'Attention Needed for Your Vehicle',
            message,
